...
$('body').on('click', 'a.btnEditPassenger', function () {
    ...
    var serviceJobId = $('#' + tableIndex + 'ServiceJobId').val();
    ...
    //if (IsPassengerServiceJobEditable()) {
    //    $('#divPassengerSJ').show();
    //    $('#WorkOrderPassengerServiceJobs').val(serviceJobId);
    //}
    //else {
    //    $('#divPassengerSJ').hide();
    //}
...
$('#btnEditPassenger').click(function (e) {
    ...
    //PCR2021
    if (IsPassengerVehicleEditable()) {
        $('#' + tableIndex + 'VehicleId').val(vehicleId);
    }

    //PCR2021
    //if (IsPassengerServiceJobEditable()) {
    //    let serviceJobId = $('#WorkOrderPassengerServiceJobs').val();
    //    $('#' + tableIndex + 'ServiceJobId').val(serviceJobId);
    //}
...
function clearPassenger() {
    ...
    $('#Vehicles').val(null);
    $('#txtNoOfPax').val(0);
    $('#WorkOrderPassengerServiceJobs').val(null);
}
...
//PCR2021
function IsPassengerVehicleEditable() {

    let currentStatus = $('#Status').val();

    // currentStatus == 'Submitted' || currentStatus == 'Verified' || currentStatus == 'With_Accounts' || currentStatus == 'Billed')
    if (currentStatus == '70' || currentStatus == '80' || currentStatus == '90' || currentStatus == '100') {
        return false;
    }
    else {
        return true;
...
//PCR2021
//function IsPassengerServiceJobEditable() {

//    let currentStatus = $('#Status').val();
//    // currentStatus == 'Submitted' || currentStatus == 'Verified'
//    if (currentStatus == '70' || currentStatus == '80') {
//        return true;
//    }
//    else {
//        return false;
