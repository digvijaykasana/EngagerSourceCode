...
{
    public class HotelController : BaseController<HotelCri, Hotel, IHotelService>
    {
        ISystemSettingService _systemSettingService;

        public HotelController(IHotelService service,
            ISystemSettingService systemSettingService) : base(service)
        {
            this._defaultColumn = "Name";
            this._systemSettingService = systemSettingService;
        }

        protected override HotelCri GetCri()
        {
            var cri = base.GetCri();
