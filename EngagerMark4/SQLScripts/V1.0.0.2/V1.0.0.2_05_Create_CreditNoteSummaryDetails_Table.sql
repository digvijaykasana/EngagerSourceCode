/****** Object:  Table [SOP].[Tb_CreditNoteSummaryDetails]    Script Date: 7/4/2019 5:16:24 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE TABLE [SOP].[Tb_CreditNoteSummaryDetails](
	[Id] [bigint] IDENTITY(1,1) NOT NULL,
	[CreditNoteSummaryId] [bigint] NOT NULL,
	[SalesInvoiceSummaryId] [bigint] NOT NULL,
	...
	[State] [int] NOT NULL,
 CONSTRAINT [PK_SOP.Tb_CreditNoteSummaryDetails] PRIMARY KEY CLUSTERED 
(
	[Id] ASC
...
ALTER TABLE [SOP].[Tb_CreditNoteSummaryDetails]  WITH CHECK ADD  CONSTRAINT [FK_SOP.Tb_CreditNoteSummaryDetails_SOP.Tb_CreditNoteSummary_CreditNoteSummaryId] FOREIGN KEY([CreditNoteSummaryId])
REFERENCES [SOP].[Tb_CreditNoteSummary] ([Id])
ON DELETE CASCADE
GO

ALTER TABLE [SOP].[Tb_CreditNoteSummaryDetails] CHECK CONSTRAINT [FK_SOP.Tb_CreditNoteSummaryDetails_SOP.Tb_CreditNoteSummary_CreditNoteSummaryId]
GO
