/****** Object:  Table [SOP].[Tb_WorkOrderHistory]    Script Date: 10/8/2019 4:29:17 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE TABLE [SOP].[Tb_WorkOrderHistory](
	...
	[State] [int] NOT NULL,
 CONSTRAINT [PK_SOP.Tb_WorkOrderHistory] PRIMARY KEY CLUSTERED 
(
	[Id] ASC
