...
{
    [Serializable]
    [Table("Tb_Function", Schema = "Core")]
    public class Function : BasicEntity
    {
        [StringLength(256)]
        [Required]
        ...
        [NotMapped]
        public IEnumerable<string> FontAwesomeList
        {
            get
            {
